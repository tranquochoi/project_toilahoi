...
using System;
    ...
    class Production_Staff: Staff
    {
        ...
        public Production_Staff(): base()
        {}

        public Production_Staff(string hoTen, string ngaySinh, double luong, double luongCanBan, int soSanPham): base(hoTen, ngaySinh, luong)
        {
            _luongCanBan = luongCanBan;
            _soSanPham = soSanPham;
        }

        public Production_Staff(Production_Staff ps):base((Production_Staff) ps)
        {
